...
const (
	sigkey    = "dev.forge.imageforge/signature"
	sigts     = "dev.forge.imageforge/timestamp"
	certkey   = "dev.forge.imageforge/certificate"
	chainkey  = "dev.forge.imageforge/chain"
	BundleKey = "dev.forge.imageforge/bundle"
)
